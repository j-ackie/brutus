...
import { ChatType } from '../messageQueries'
import { Label, SubHeading } from '../../../global/Text'
import { COLORS } from '../../../global/Colors'

function ChatCard({chat, ...props} : {chat : ChatType, [x:string]:any}) {
  ...
  return (
    <div className="w-3/5 bg-white rounded-xl p-8 mt-4 flex flex-row items-center" {...props}>
